...
class Transformer(hk.Module):
    def __init__(self, dim:int, heads:int, name = "transformer"):
        ...
        self.Attn = MhAttention(dim, heads)
...
class Hyuga_neuro05(hk.Module):
    def __init__(
        ...
        self.blocks = [
            Transformer(self.dim, self.heads, name=f"transformer_{i}") for i in range(self.num_layers)
        ]
